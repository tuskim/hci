...
// comn : Web Style
    ...
    case "comn":
      ...
      selectionColor   = "<SC>Type='FocusEditCol', BgColor='#fffed3', TextColor='#000000'</SC>" +
                         "<SC>Type='EditCol', BgColor='#fffed3', TextColor='#000000'</SC>" +
						 //Editable 영역 행 선택시
                         "<SC>Type='FocusEditRow', BgColor='#fffed3', TextColor='#000000'</SC>" +
                         "<SC>Type='EditRow', BgColor='#fffed3', TextColor='#000000'</SC>" +
						 //non-Editable 영역 컬럼 선택시
                         "<SC>Type='FocusCurCol', BgColor='#fffed3', TextColor='#000000'</SC>" +
                         "<SC>Type='CurCol', BgColor='#fffed3', TextColor='#000000'</SC>" +
						 //non-Editable 영역 행 선택시
                         "<SC>Type='FocusCurRow', BgColor='#fffed3', TextColor='#000000'</SC>" +
                         "<SC>Type='CurRow', BgColor='#fffed3', TextColor='#000000'</SC>" +
						 //MultiSelect시 현재 커서가 있는 영역을 #E8F5FF 선택된 영역
                         "<SC>Type='FocusSelRow', BgColor='#fffed3', TextColor='#000000'</SC>" +
                         "<SC>Type='SelRow', BgColor='#fffed3', TextColor='#000000'</SC>";
	  ...
	  //CBgColor		   = "{decode(currow-tointeger(currow/2)*2,0,'#FFFFFF',1,'#f5f5f5')}";
      FCColor          = "#000000";
      FCBgColor        = "{decode(currow-tointeger(currow/2)*2,0,'#FFFFFF',1,'#FFFFFF')}"; //"#F0F0F0"
      ...
      HeadBgColor1     = "#F0F3F8";
      HeadColorF1      = "#8591A9";
      HeadBgColorF1    = "#F0F3F8";
      HeadColor2       = "#8591A9";
      HeadBgColor2     = "#F0F3F8";
      HeadColorF2      = "#8591A9";
      HeadBgColorF2    = "#F0F3F8";
      HeadColor3       = "#8591A9";
      HeadBgColor3     = "#F0F3F8";
      HeadColorF3      = "#8591A9";
      HeadBgColorF3    = "#F0F3F8";
...
function cfShowDSWaitMsg(gr) {
	...
	if (document.all(gr.id+"WaitMsg") == null) {
		//document.body.insertAdjacentHTML("beforeEnd", "<IFRAME id='" + gr.id + "WaitMsg' style='position:absolute; left:0px; top:5px; width:" + msgWidth + "; height:26' frameborder='0' src='/vmihub/sys/images/progress_bar.gif' scrolling='no'></IFRAME>");
