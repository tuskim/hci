...
<%@ page language="java" pageEncoding="EUC-KR"
	contentType="text/html; charset=EUC-KR" isErrorPage="true"
	session="false" import="devon.core.util.stopwatch.LHistorialWatch"
	import="devon.core.util.LHtmlUtils" import="devon.core.log.LLog"
...
Throwable throwable = (Throwable)request.getAttribute(uip.common.util.Constants.SERVLET_ERROR_EXCEPTION_KEY);
