...
function f_calculation() {
	...
	ds_master.NameValue(ds_master.RowPosition, "cementBagQty") =  prodOutQtySum / 50; // 1 BAG = 50 KG
	ds_result.NameValue(ds_result.RowPosition, "prodInQty") =  prodOutQtySum / 50; // 1 BAG = 50 KG
}
