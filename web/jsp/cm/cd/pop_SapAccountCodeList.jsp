...
function f_select(row,colid) {
    ...
    if(row>0){
        ...
        var special      = ds_grid.NameValue(row , "sp" );
        var chkyn        = ds_grid.NameValue(row , "chkyn" );
        var checkDuedate = ds_grid.NameValue(row , "checkDuedate" );
...
<body style="background-color:#34a8db;padding-left:2px;padding-top:2px;padding-right:2px;">
	...
	<div class="pad_t5"></div>
		<!-- �׸��� S -->	
		<div id="n_board_area">
			<object id="gr_grid" classid="<%=LGauceId.GRID %>" class="comn" style="width:100%;height:265px;"
			      ...
			      <param name="Format"
			        value='
			              ...
			              <C> id="name"          name="Name"      		align="left"   Edit="none" width="295"  </C>
			              <C> id="useyn"         name="Use Y/N"         align="center" Edit="none" width="60"  </C>
			              <C> id="sp"            name="Special"         align="center" Edit="none" width="60"  show=false</C>
			              <C> id="chkyn"         name="check Yn"        align="center" Edit="none" width="60"  show=false</C>
			        '>
			</object>
		</div>
