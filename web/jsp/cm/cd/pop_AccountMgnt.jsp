...
<title> SAP Account Code List</title>
...
function f_Retrieve() {
    ...
    condition += "&acctSapCd="  + document.all.acctSapCd.value;


    ds_grid.DataID = "cm.cm.RetrieveSapAcctCd.gau"+condition;
    ds_grid.Reset();
}
   ...
   if ( useyn != "Y" ) {
    ...
    if(row>0){
        var acctSapCd 	= ds_grid.NameValue(row , "acctSapCd" );
   	    var acctSapNmEn = ds_grid.NameValue(row , "acctSapNmEn" );

        window.returnValue = acctSapCd + ";"  + acctSapNmEn + ";" ;
...
<body style="background-color:#34a8db;padding-left:5px;">
    ...
    <div id="pop_ContentsBox">    
		<div id="TitleArea2"><h1> SAP Account Code List</h1> </div>    
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="output_board2" >
						<colgroup>
						 ...
						 <tr>
							...
							<td><input type="text" id="acctSapCd" style="width:100px;" /></td>
						</tr>
					</table>
				</dt>              		  	   	 	
	...
	<div class="pad_t5"></div>
		...
		<div id="n_board_area">
			<object id="gr_grid" classid="<%=LGauceId.GRID %>" class="comn" style="width:100%;height:200px;"
			      ...
			      <param name="Format"
			        value='
			              <C> id="acctSapCd"         name="Code"     align="center" Edit="none" width="90"  </C>
			              <C> id="acctSapNmEn"       name="Name"     align="center" Edit="none" width="180"  </C>
			              <C> id="useyn"   			 name="Use Y/N"  align="center" Edit="none" width="55"  </C>
			        '>
			</object>
		</div>
