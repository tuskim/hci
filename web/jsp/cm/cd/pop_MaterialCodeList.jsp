<%--
 *************************************************************************
 * @source  : pop_MaterialCodeList.jsp
...
function f_Retrieve() {
    ...
    ds_grid.DataID = "retrieveMaterialCodeListPopup.gau"+condition;
    ds_grid.Reset();
}
				...
				<dt class="w400"> 
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="output_board2" >
						<colgroup>
						 ...
						 <tr>
							<th>Material Name </th>
							<td><input type="text" id="materNm" style="width:120px;" /></td>
						</tr>
					</table>
				</dt>              		  	   	 	
			...
			<object id="gr_grid" classid="<%=LGauceId.GRID %>" class="comn" style="width:100%;height:200px;"
			      ...
			      <param name="Format"
			        value='
			              ...
			              <C> id="materCd"        name="Code"     		align="center" Edit="none" width="80" </C>
			              <C> id="materNm"        name="Name"     		align="left"   Edit="none" width="105"  </C>
			              <C> id="unit"           name="Unit"           align="left"   Edit="none" width="30"  </C>
