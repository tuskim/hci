/*
 *------------------------------------------------------------------------------
 * RetrievePurchOrderRegMainListCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrievePurchOrderRegMainListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrievePurchOrderRegMainListCmd --> Start \n");		
		...
		LMultiData result = biz.retrievePurchOrderRegMainList(inputData);
		...
		LLog.info.write("\n RetrievePurchOrderRegMainListCmd --> End \n");		
