/*
 *------------------------------------------------------------------------------
 * CudPurchOrderUpdatePrintDateCmd.java,v 1.0 2016/09/20 10:23:35 
 * 
 * PROJ : PT-PAM System.
 ...
 * -----------  ------  ---------------------------------------------------------
 * 2016/09/20   kjkim   Init    print 출력 시 출력일자 업데이트
 *----------------------------------------------------------------------------
 */
 ...
 * @see       
 */
public class CudPurchOrderUpdatePrintDateCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudPurchOrderUpdatePrintDateCmd ------------ START");
		...
		LLog.debug.write("CudPurchOrderUpdatePrintDateCmd inputm ---------------> =>\n " + inputm);
		
		PurchOrderRegBiz biz = new PurchOrderRegBiz(); 
		
		//프린트 출력 후 프린트 일자 업데이트
		resultData = biz.updatePurchOrderPrintdate(inputm, loginUser);
		...
		LLog.debug.write("CudPurchOrderUpdatePrintDateCmd ------------ END");
