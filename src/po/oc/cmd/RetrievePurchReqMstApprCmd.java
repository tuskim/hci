/*
 *------------------------------------------------------------------------------
 * RetrievePurchReqMstApprCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrievePurchReqMstApprCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrievePurchReqMstApprCmd --> Start \n");		
		...
		LMultiData result = biz.retrievePurchReqMstAppr(inputData);
		
		LLog.info.write("\n RetrievePurchReqMstApprCmd result:" + result.toString());		
		//req.setAttribute("resultData", result);

	    LGauceConverter.extractToGauceDataSet(result, gds);
	    gds.flush();
	    
		LLog.info.write("\n RetrievePurchReqMstApprCmd --> End \n");		
