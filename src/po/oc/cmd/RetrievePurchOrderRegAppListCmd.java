/*
 *------------------------------------------------------------------------------
 * RetrievePurchOrderRegAppListCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrievePurchOrderRegAppListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrievePurchOrderRegAppListCmd --> Start \n");		
		...
		LMultiData result = biz.retrievePurchOrderRegAppList(inputData);
		...
		LLog.info.write("\n RetrievePurchOrderRegAppListCmd --> End \n");		
