/* ------------------------------------------------------------------------
 * @source  : RetrievePurchOrderHistoryListCmd.java
 * @desc    : PurchOrder
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
 ...
 * ---  -----------  -----------------  -----------------------------------
 * 1.0  2011.02.09   kangsoo                   Initial
 * ------------------------------------------------------------------------ */
package po.oc.cmd;
...
import po.oc.biz.PurchOrderHistoryBiz;
...
public class RetrievePurchOrderHistoryListCmd implements LGauceCommandIF{
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
    	...
    	LLog.info.write("\n RetrievePurchOrderHistoryListCmd --> Start \n");	

    	PurchOrderHistoryBiz biz = new PurchOrderHistoryBiz();
