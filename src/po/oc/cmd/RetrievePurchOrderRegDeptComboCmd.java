/*
 *------------------------------------------------------------------------------
 * RetrievePurchOrderRegDeptComboCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrievePurchOrderRegDeptComboCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n retrievePurchOrderRegDeptCombo --> Start \n");		
		...
		LMultiData result = biz.retrievePurchOrderRegDeptCombo(inputData);
		...
		LLog.info.write("\n retrievePurchOrderRegDeptCombo --> End \n");		
