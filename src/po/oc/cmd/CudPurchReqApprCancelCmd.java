/*
 *------------------------------------------------------------------------------
 * CudPurchReqApprCancelCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM System.
 ...
 * @see       
 */
public class CudPurchReqApprCancelCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudPurchReqApprCancelCmd ------------ START");
		...
		LLog.debug.write("CudPurchReqApprCancelCmd inputData ---------------> =>\n " + inputData.toString());

		PurchReqApprBiz biz = new PurchReqApprBiz();
		resultData = biz.updatePurchReqApprApply(inputData, loginUser); 
		...
		LLog.debug.write("CudPurchReqApprCancelCmd ------------ END");
