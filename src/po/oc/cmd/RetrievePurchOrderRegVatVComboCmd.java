/*
 *------------------------------------------------------------------------------
 * RetrievePurchOrderRegVatVComboCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrievePurchOrderRegVatVComboCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrievePurchOrderRegVatVComboCmd --> Start \n");		
		...
		LMultiData result = biz.retrievePurchOrderRegVatVCombo(inputData);
		...
		LLog.info.write("\n RetrievePurchOrderRegVatVComboCmd --> End \n");		
