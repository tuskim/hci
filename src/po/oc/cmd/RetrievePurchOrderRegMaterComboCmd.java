/*
 *------------------------------------------------------------------------------
 * RetrievePurchOrderRegMaterComboCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrievePurchOrderRegMaterComboCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrievePurchOrderRegMaterComboCmd --> Start \n");		
		...
		LMultiData result = biz.retrievePurchOrderRegMaterCombo(inputData);
		...
		LLog.info.write("\n RetrievePurchOrderRegMaterComboCmd --> End \n");		
