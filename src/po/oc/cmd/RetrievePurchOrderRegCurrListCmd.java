/*
 *------------------------------------------------------------------------------
 * RetrievePurchOrderRegCurrListCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrievePurchOrderRegCurrListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LMultiData result = biz.retrievePurchOrderRegCurrList(inputData);
