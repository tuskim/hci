/*
 *------------------------------------------------------------------------------
 * RetrievePurchOrderRegDetailListCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrievePurchOrderRegDetailListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrievePurchOrderRegDetailListCmd --> Start \n");		
		...
		LMultiData result = biz.retrievePurchOrderRegDetailList(inputData);
		...
		LLog.info.write("\n RetrievePurchOrderRegDetailListCmd --> End \n");		
