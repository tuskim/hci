/*
 *------------------------------------------------------------------------------
 * CudPurchReqApprApplyCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM System.
 ...
 * @see       
 */
public class CudPurchReqApprApplyCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudPurchReqApprApplyCmd ------------ START");
		...
		LLog.debug.write("CudPurchReqApprApplyCmd inputData ---------------> =>\n " + inputData.toString());
		...
		LLog.debug.write("CudPurchReqApprApplyCmd ------------ END");
