/*
 *------------------------------------------------------------------------------
 * CudPurchOrderRegCmd.java,v 1.0 2010/08/03 16:43:35 
 * 
 * PROJ : PT-PAM System.
 ...
 * @see       
 */
public class CudPurchOrderRegCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LMultiData MDataTax = LGauceConverter.convertToLMultiDataWithJobType(taxGds);
		LMultiData MDataApp    = LGauceConverter.convertToLMultiDataWithJobType(appGds);		
		LLog.debug.write("CudPurchOrderRegCmd MDataMain ---------------> =>\n " + MDataMain);
		LLog.debug.write("CudPurchOrderRegCmd MDataDetail ---------------> =>\n " + MDataDetail);	
		LLog.debug.write("CudPurchOrderRegCmd MDataDetail ---------------> =>\n " + MDataTax);
		LLog.debug.write("CudPurchOrderRegCmd MDataApp ---------------> =>\n " + MDataApp);
		loginUser.set("poNo", inputData.get("poNo"));
		PurchOrderRegBiz biz = new PurchOrderRegBiz(); 
		resultData = biz.cudPurchOrderReg(MDataMain, MDataDetail,MDataTax ,MDataApp, loginUser);
		...
		LLog.debug.write("CudPurchOrderRegCmd ------------ END");
