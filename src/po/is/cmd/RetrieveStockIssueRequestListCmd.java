/* ------------------------------------------------------------------------
 * @source  : RetrieveStockIssueRequestListCmd.java
 * @desc    : 출고 요청 목록 조회
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class RetrieveStockIssueRequestListCmd implements LGauceCommandIF {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
		...
		LLog.debug.write("RetrieveStockIssueRequestListCmd --> Start");
		...
		LGauceConverter.extractToGauceDataSet( biz.retrieveIssueRequestList(lData), dsGrid );
		dsGrid.flush();
		
		LLog.debug.write("RetrieveStockIssueRequestListCmd --> End");		
    }
