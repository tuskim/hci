 ...
 * @see       
 */
public class RetrieveStockMoveCancelMstCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveStockMoveCancelMstCmd -------> Start \n");		
		...
		LMultiData result = biz.RetrieveStockMoveMst(inputData);
		
	    LGauceConverter.extractToGauceDataSet(result, gds);
	    gds.flush();
	    
		LLog.info.write("\n RetrieveStockMoveCancelMstCmd -----------> End \n");		
