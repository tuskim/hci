/* ------------------------------------------------------------------------
 * @source  : CudStockMoveRejectCmd.java
 * @desc    : 출고등록
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudStockMoveRejectCmd implements LGauceCommandIF {

	public void execute(HttpServletRequest req, HttpServletResponse res, 
	        GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
				
		LLog.debug.write("CudStockMoveRejectCmd inputData--------------- Start \n");
		...
		LLog.debug.println("CudStockMoveRejectCmd inputData--------------- =>\n " + harderData.toString());
	
		StockMoveBiz biz = new StockMoveBiz();
		resultData = biz.rejectStockMove(harderData, bodyData, loginUser);
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudStockMoveRejectCmd inputData--------------- End \n");
