/* ------------------------------------------------------------------------
 * @source  : CudStockMoveCancelCmd.java
 * @desc    : Stock Movemnet Cancel
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
 * VER  DATE         AUTHOR             DESCRIPTION
 * ---  -----------  -----------------  -----------------------------------
 * 1.0  2010.08.27   mskim              Initial
 * ------------------------------------------------------------------------ */
...
public class CudStockMoveCancelCmd implements LGauceCommandIF {

	public void execute(HttpServletRequest req, HttpServletResponse res, 
	        GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
				
		LLog.debug.write("CudStockMoveCancelCmd inputData--------------- Start \n");
		...
		LLog.debug.println("CudStockMoveCancelCmd inputData--------------- =>\n " + harderData.toString());
	
		StockMoveCancelBiz biz = new StockMoveCancelBiz();
		resultData = biz.saveStockMoveCancel(harderData, bodyData, loginUser);
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudStockMoveCancelCmd inputData--------------- End \n");
