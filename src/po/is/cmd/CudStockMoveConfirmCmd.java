/* ------------------------------------------------------------------------
 * @source  : CudStockMoveConfirmCmd.java
 * @desc    : 출고등록
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudStockMoveConfirmCmd implements LGauceCommandIF {

	public void execute(HttpServletRequest req, HttpServletResponse res, 
	        GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
				
		LLog.debug.write("CudStockMoveConfirmCmd inputData--------------- Start \n");
		...
		LLog.debug.println("CudStockMoveConfirmCmd inputData--------------- =>\n " + harderData.toString());
	
		StockMoveBiz biz = new StockMoveBiz();
		resultData = biz.confirmStockMove(harderData, bodyData, loginUser);
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudStockMoveConfirmCmd inputData--------------- End \n");
