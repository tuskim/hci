 ...
 * @see       
 */
public class RetrieveStockExcelDownListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveStockExcelDownListCmd -------> Start \n");		
		...
		LMultiData result = biz.RetrieveStockExcelDownList(inputData);
		
	    LGauceConverter.extractToGauceDataSet(result, gds);
	    gds.flush();
	    
		LLog.info.write("\n RetrieveStockExcelDownListCmd -----------> End \n");		
