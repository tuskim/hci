/* ------------------------------------------------------------------------
 * @source  : CudStockMoveSaveCmd.java
 * @desc    : 출고등록
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudStockMoveSaveCmd implements LGauceCommandIF {

	public void execute(HttpServletRequest req, HttpServletResponse res, 
	        GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
				
		LLog.debug.write("CudStockMoveSaveCmd inputData--------------- Start \n");
		...
		LLog.debug.println("CudStockMoveSaveCmd inputData--------------- =>\n " + harderData.toString());
	
		StockMoveBiz biz = new StockMoveBiz();
		resultData = biz.saveStockMoveQuantity(harderData, bodyData, loginUser);
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudStockMoveSaveCmd inputData--------------- End \n");
