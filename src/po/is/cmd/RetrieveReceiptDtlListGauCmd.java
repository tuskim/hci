...
public class RetrieveReceiptDtlListGauCmd implements LGauceCommandIF {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
		...
		LLog.info.write("\n RetrieveReceiptDtlListGauCmd --> Start \n");		
		...
		LMultiData result = biz.retrieveReceiptDetailList(inputData);
		
		LLog.info.write("\n RetrieveReceiptDtlListGauCmd result:" + result.toString());		
		//req.setAttribute("resultData", result);

	    LGauceConverter.extractToGauceDataSet(result, gds);
	    gds.flush();
	    
		LLog.info.write("\n RetrieveReceiptDtlListGauCmd --> End \n");		
