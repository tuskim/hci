/* ------------------------------------------------------------------------
 * @source  : CudStockMoveListCmd.java
 * @desc    : 출고등록
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudStockMoveListCmd implements LGauceCommandIF {

	public void execute(HttpServletRequest req, HttpServletResponse res, 
	        GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
				
		LLog.debug.write("CudStockMoveListCmd inputData--------------- Start \n");
		...
		LLog.debug.println("CudStockMoveListCmd inputData--------------- =>\n " + harderData.toString());
	
		StockMoveBiz biz = new StockMoveBiz();
		resultData = biz.saveStockMove(harderData, bodyData, loginUser);
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudStockMoveListCmd inputData--------------- End \n");
