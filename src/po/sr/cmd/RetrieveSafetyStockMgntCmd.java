...
public class RetrieveSafetyStockMgntCmd implements LGauceCommandIF {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
    	...
    	LLog.info.write("\n RetrieveSafetyStockMgntCmd --> Start \n");	
		...
		LMultiData result = biz.retrieveSafetyStockMgntList(inputData);
		
	    LGauceConverter.extractToGauceDataSet(result, gds);
	    gds.flush(); 
		
		LLog.info.write("\n RetrieveSafetyStockMgntCmd --> End \n");
