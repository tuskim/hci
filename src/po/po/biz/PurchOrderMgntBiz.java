 ...
 * @author    CEH
 */
public class PurchOrderMgntBiz {
    /**
     ...
     ** @exception LException 메소드 수행시 발생한 모든 에러.
     */	
    public LMultiData retrievePurchOrderMgntMainList(LData inputData) throws LException {
        LMultiData list = null;

        try {
 
            LCommonDao dao = new LCommonDao("po/po/purchOrderMgntSql/retrievePurchOrderMgntMainList", inputData);
     ...
     ** @exception LException 메소드 수행시 발생한 모든 에러.
     */	
    public LMultiData retrievePurchOrderMgntDetailList(LData inputData) throws LException {
        LMultiData list = null;

        try {
 
            LCommonDao dao = new LCommonDao("po/po/purchOrderMgntSql/retrievePurchOrderMgntDetailList", inputData);
     ...
     ** @exception LException 메소드 수행시 발생한 모든 에러.
     */	
    public LMultiData retrievePurchOrderMgntAppList(LData inputData) throws LException {
        LMultiData list = null;

        try {
 
            LCommonDao dao = new LCommonDao("po/po/purchOrderMgntSql/retrievePurchOrderMgntAppList", inputData);
