/*
 *------------------------------------------------------------------------------
 * RetrieveOpenPurchOrderMasterListCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
...
import po.po.biz.OpenPurchOrderBiz;
 ...
 * @see       
 */
public class RetrieveOpenPurchOrderMasterListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveOpenPurchOrderMasterListCmd --> Start \n");		
	    ...
	    OpenPurchOrderBiz biz = new OpenPurchOrderBiz();

	    LMultiData result = null;
    	result = biz.retrieveOpenPurchOrderMasterList(inputData);
		LLog.info.write(result.toString());		
		...
		LLog.info.write("\n RetrieveOpenPurchOrderMasterListCmd --> End \n");		
