...
public class RetrievePurchOrderMgntDetailListCmd implements LGauceCommandIF {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
    	...
    	LLog.info.write("\n RetrievePurchOrderMgntDetailListCmd --> Start \n");	
		...
		LMultiData result = biz.retrievePurchOrderMgntDetailList(inputData);
		
	    LGauceConverter.extractToGauceDataSet(result, gds);
	    gds.flush(); 
		
		LLog.info.write("\n RetrievePurchOrderMgntDetailListCmd --> End \n");
