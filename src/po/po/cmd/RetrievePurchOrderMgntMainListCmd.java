...
public class RetrievePurchOrderMgntMainListCmd implements LGauceCommandIF {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
    	...
    	LLog.info.write("\n RetrievePurchOrderMgntMainListCmd --> Start \n");	
		...
		LMultiData result = biz.retrievePurchOrderMgntMainList(inputData);
		
	    LGauceConverter.extractToGauceDataSet(result, gds);
	    gds.flush(); 
		
		LLog.info.write("\n RetrievePurchOrderMgntMainListCmd --> End \n");
