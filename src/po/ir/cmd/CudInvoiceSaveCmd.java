...
public class CudInvoiceSaveCmd implements LGauceCommandIF {

	public void execute(HttpServletRequest req, HttpServletResponse res, 
	        GauceRequest gauceRequest, GauceResponse gauceResponse) throws LException  {
				
		LLog.debug.write("CudInvoiceSaveCmd inputData--------------- Start \n");
		...
		if(userGdsMst == null || userGdsDtl == null ){
			LLog.debug.write("CudInvoiceSaveCmd : DS_GRID   Null Point Error! \n");
			return;
		}
		...
		LLog.debug.println("CudInvoiceSaveCmd inputData Mst--------------- =>\n " + mDataMst.toString());
		LLog.debug.println("CudInvoiceSaveCmd inputData Dtl --------------- =>\n " + mDataDtl.toString());
		LLog.debug.println("CudInvoiceSaveCmd inputData tax --------------- =>\n " + mDataTax.toString());
	
		InvoiceRegBiz biz = new InvoiceRegBiz();
		
		resultData = biz.cudInvoice(mDataMst, mDataDtl, mDataTax, lData);		
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudInvoiceSaveCmd inputData--------------- End \n");
