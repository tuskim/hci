...
public class RetrieveDataInputMonitoringEmailListCmd implements LGauceCommandIF{
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		GauceDataSet 	dsMain 	= new GauceDataSet("ds_email");
		...
		result= biz.retrieveDataInputEmailList(lData);
