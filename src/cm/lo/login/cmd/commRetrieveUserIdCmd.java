 ...
 * @see       
 */
public class commRetrieveUserIdCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception { 
		...
		LLog.debug.write("inputData\n ===== " + inputData);
		commRetrieveUserBiz Biz = new commRetrieveUserBiz();
		LMultiData result = Biz.commRetrieveUserId(inputData);
		GauceDataSet gds = new GauceDataSet("ds_findId");
