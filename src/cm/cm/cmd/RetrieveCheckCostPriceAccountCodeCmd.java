/*
 *------------------------------------------------------------------------------
 * RetrieveCheckAccountCodeCmd.java,v 1.0 2010/05/30 16:43:35 
 * 
 * PROJ : JIT-HUB 
 ...
 * @see       
 */
public class RetrieveCheckCostPriceAccountCodeCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws LException {
		...
		LMultiData result = biz.retrieveCheckCostPriceAccountCode(inputData);
