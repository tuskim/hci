/*
 *------------------------------------------------------------------------------
 * RetrieveLgeSiteComboGauCmd.java,v 1.0 
 * 
 * PROJ :
 ...
 * @see       
 */
public class RetrieveCommDefaultDeptCdCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws LException {
		...
		LMultiData result = biz.retrieveCommDefaultDeptCd(inputData);
