 ...
 * @see       
 */
public class RetrieveCodeMgntDupCntCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception { 
		...
		LMultiData result = Biz.RetrieveDupCnt(inputData);
		GauceDataSet gds = new GauceDataSet("ds_dup");
