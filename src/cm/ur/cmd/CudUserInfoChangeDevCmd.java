/* ------------------------------------------------------------------------
 * @source  : CudUserInfoChangeDevCmd.java
 * @desc    : 사용자 개인정보 변경
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
 ...
 * ---  -----------  -----------------  -----------------------------------
 * 1.0  2016.04.04    hskim			     CSR:C20160330_24662 가우스 Dataset 방식에서 서블릿 방식으로 변경 (SSL)
 * ------------------------------------------------------------------------ */
...
public class CudUserInfoChangeDevCmd implements  LCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		try {
			...
			long   getErrorCode = 0 ;
			String getMessage   = "successfully saved.";
	    	...
	    	if(newPw == null || newPw.equals(""))//신규 패스워드 없음
	    	{
	    		 ...
	    		 {  LLog.info.println("Case1. 신규 패스워드 입력 안함, 기존 PW와 다름");
	    		 	getMessage=  "Check the current password";
	    	...
	    	resultMsg.setString("message", getMessage);
