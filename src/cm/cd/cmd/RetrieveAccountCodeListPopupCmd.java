/*
 *------------------------------------------------------------------------------
 * RetrieveAccountCodeListPopupCmd.java,v 1.0 2010/05/30 16:43:35 
 * 
 * PROJ : PT-PAM System
...
public class RetrieveAccountCodeListPopupCmd implements LGauceCommandIF{
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LMultiData result = biz.retrieveAccountCodeListPopup(inputData);
