/*
 *------------------------------------------------------------------------------
 * RetrieveMaterPopupPoComboCmd.java,v 1.0 2010/05/30 16:43:35 
 * 
 * PROJ : PT-PAM System
...
public class RetrieveMaterPopupPoComboCmd implements LGauceCommandIF{
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveMaterPopupPoComboCmd --> Start \n");
		...
		LMultiData result = biz.retrieveMaterPopupPoCombo(inputData);
	    LGauceConverter.extractToGauceDataSet(result, gds);
	    gds.flush();
	    
		LLog.info.write("\n RetrieveMaterPopupPoComboCmd --> End \n");
	}
}