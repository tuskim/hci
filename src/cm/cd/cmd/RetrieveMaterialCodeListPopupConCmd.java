...
public class RetrieveMaterialCodeListPopupConCmd implements LGauceCommandIF{
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveMaterialCodeListPopupConCmd --> Start \n");
		...
		LMultiData result = biz.retrieveMaterialCodeListPopupCon(inputData);
	    LGauceConverter.extractToGauceDataSet(result, gds);
	    gds.flush();
	    
		LLog.info.write("\n RetrieveMaterialCodeListPopupConCmd --> End \n");
	}
}