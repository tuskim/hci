/*
 *------------------------------------------------------------------------------
 * RetrieveMaterialCodeListPopupConCmd.java,v 1.0 2010/05/30 16:43:35 
 * 
 * PROJ : PT-PAM System
...
public class RetrieveProductMaterialCodeListPopupConCmd implements LGauceCommandIF{
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveProductMaterialCodeListPopupConCmd --> Start \n");
		...
		LMultiData result = biz.retrieveProductMaterialCodeListPopupCon(inputData);
	    LGauceConverter.extractToGauceDataSet(result, gds);
	    gds.flush();
	    
		LLog.info.write("\n RetrieveProductMaterialCodeListPopupConCmd --> End \n");
	}
}