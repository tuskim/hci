/*
 *------------------------------------------------------------------------------
 * RetrieveMaterialCodeListCmd.java,v 1.0 2010/05/30 16:43:35 
 * 
 * PROJ : PT-PAM System
...
public class RetrieveMaterialCodeListPopupCmd implements LGauceCommandIF{
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveMaterialCodeListPopupCmd --> Start \n");
		...
		LMultiData result = biz.retrieveMaterialCodeListPopup(inputData);
	    LGauceConverter.extractToGauceDataSet(result, gds);
	    gds.flush();
	    
		LLog.info.write("\n RetrieveMaterialCodeListPopupCmd --> End \n");
	}
}