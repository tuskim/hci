/*
 *------------------------------------------------------------------------------
 * CudProgAuthorityCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : JIT-HUB 
 ...
 * @see       
 */
public class CudProgAuthorityCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudProgAuthorityCmd inputData--------------- Start \n");
		...
		resultData = biz.cudProgAuthority(mData, loginUser); 
		...
		LLog.debug.write("CudProgAuthorityCmd inputData--------------- End \n");
	}
}
