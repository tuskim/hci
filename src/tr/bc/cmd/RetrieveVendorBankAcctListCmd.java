/*
 *------------------------------------------------------------------------------
 * RetrieveVendorBankAcctListCmd.java,v 1.0 2015/11/26 09:41:35 
 * 
 * PROJ : PT-PAM System
...
public class RetrieveVendorBankAcctListCmd implements LGauceCommandIF{
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveVendorBankAcctListCmd --> Start \n");
		...
		LMultiData result = biz.retrieveVendorBankAcctListPopup(inputData);
	    LGauceConverter.extractToGauceDataSet(result, gds);
	    gds.flush();
	    
		LLog.info.write("\n RetrieveVendorBankAcctListCmd --> End \n");
	}
}