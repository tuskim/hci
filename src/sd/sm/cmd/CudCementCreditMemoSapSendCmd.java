/*
 *------------------------------------------------------------------------------
 * CudCpoCreditMemoSapSendCmd.java,v 1.0
 * 
 * PROJ : PT-PAM System.
 ...
 * @see       
 */
public class CudCementCreditMemoSapSendCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudCementCreditMemoSapSendCmd ------------ START");

		GauceDataSet saleConFirmList = gauceRequest.getGauceDataSet("IN_DS1");
		
		LData inputData = LXssCollectionUtility.getData(req);
		LLog.debug.write("CudCementCreditMemoSapSendCmd inputData ---------------> =>\n " + inputData.toString());
		...
		LLog.debug.write("CudCementCreditMemoSapSendCmd HEADER 자료~~~~ ---------------> =>\n " + mData.toString());


		CementSalesMgntBiz biz = new CementSalesMgntBiz();
		resultData = biz.CudCementCreditMemoSapSend(mData, loginUser);
		...
		LLog.debug.write("CudCementCreditMemoSapSendCmd ------------ END");
