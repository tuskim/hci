/*
 *------------------------------------------------------------------------------
 * CudCpoCreditMemoSapCancelCmd.java,v 1.0 2010/08/27 16:43:35 
 * 
 * PROJ : PT-PAM System.
 ...
 * @see       
 */
public class CudCementCreditMemoSapCancelCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudCementCreditMemoSapCancelCmd ------------ START");
		...
		resultData = biz.CudCpoCreditMemoSapCancel(mData, loginUser);
		...
		LLog.debug.write("CudCementCreditMemoSapCancelCmd ------------ END");
