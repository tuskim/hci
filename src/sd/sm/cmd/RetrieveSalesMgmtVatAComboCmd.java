/*
 *------------------------------------------------------------------------------
 * RetrieveSalesMgmtVatAComboCmd.java,v 1.0 2012/09/27  
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrieveSalesMgmtVatAComboCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveSalesMgmtVatAComboCmd --> Start \n");		
		...
		LMultiData result = biz.retrieveSalesMgmtVatACombo(inputData);
		...
		LLog.info.write("\n RetrieveSalesMgmtVatAComboCmd --> End \n");		
