/*
 *------------------------------------------------------------------------------
 * CudProdCPOCreditMemoMgntCmd.java,v 1.0 2012/10/10 
 * 
 * PROJ : JIT-HUB  
 ...
 * 
 */
public class CudCementCreditMemoMgntCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	try {
		 	LLog.info.write("\n CudCementCreditMemoMgntCmd --> Start \n");	
			...
			LLog.info.write("\n CudCementCreditMemoMgntCmd > main grid    -->\n" + inputm);	
			result = biz.CudProdCPOCreditMemoMgnt(inputm, loginUser); 
		...
		LLog.info.write("\n CudCementCreditMemoMgntCmd --> End \n");	
	}
}