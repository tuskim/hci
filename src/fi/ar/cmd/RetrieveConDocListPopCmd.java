/*
 *------------------------------------------------------------------------------
 * RetrieveConDocListPopCmd.java,v 1.0 2010/10/06 16:43:35 
 * 
 * PROJ : PT-PAM
 ...
 * @see       
 */
public class RetrieveConDocListPopCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveConDocListPopCmd --> Start \n");		
		...
		LMultiData result = biz.retrieveConDocListPop(inputData);
	    LGauceConverter.extractToGauceDataSet(result, gds); 
	    gds.flush();
	    
		LLog.info.write("\n RetrieveConDocListPopCmd --> End \n");		
