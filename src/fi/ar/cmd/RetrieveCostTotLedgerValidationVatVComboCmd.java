/*
 *------------------------------------------------------------------------------
 * RetrieveCostTotLedgerValidationVatVComboCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrieveCostTotLedgerValidationVatVComboCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveCostTotLedgerValidationVatVComboCmd --> Start \n");		
		...
		LMultiData result = biz.retrieveCostTotLedgerValidationVatVCombo(inputData);
		...
		LLog.info.write("\n RetrieveCostTotLedgerValidationVatVComboCmd --> End \n");		
