 ...
 * @see       
 */
public class CudApprCostTotLedgerSapCancelConfirmCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudApprCostTotLedgerSapCancelConfirmCmd ------------ START");
		...
		LLog.debug.write("CudApprCostTotLedgerSapCancelConfirmCmd mMstData ---------------> =>\n " + mMstData.toString());

		CostTotLedgerConfirmBiz biz = new CostTotLedgerConfirmBiz();
		resultData = biz.cudApprCostTotLedgerSapCancelConfirm(mMstData, loginUser); 
		...
		LLog.debug.write("CudApprCostTotLedgerSapCancelConfirmCmd ------------ END");
