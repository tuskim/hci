/* ------------------------------------------------------------------------
 * @source  : RetrieveConDocDetailCmd.java
 * @desc    : conDoc Detail 
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
 ...
 * @see       
 */
public class RetrieveConDocDetailCmd implements LCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res) throws LException {
		...
		biz.updateConDocHit(inputData);//조회수 update
		result = biz.retrieveConDocUpdate(inputData);	//conDoc Detail
