/*
 *------------------------------------------------------------------------------
 * CudCostTotLedgerDtlValidationCmd.java,v 1.0 2010/08/03 16:43:35 
 * 
 * PROJ : PT-MGE System.
 ...
 * @see       
 */
public class CudCostTotLedgerValidationCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudCostTotLedgerDtlValidationCmd inputData ---------------> =>\n " + inputData.toString());
		...
		resultData = biz.cudCostTotLedgerValidation(mMstData, mDtlData, inputData, loginUser); 
