/*
 *------------------------------------------------------------------------------
 * RetrieveCostTotLedgerMstConfirmCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrieveCostTotLedgerMstConfirmCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveCostTotLedgerMstConfirmCmd --> Start \n");		
		...
		LMultiData result = biz.retrieveCostTotLedgerMstConfirm(inputData);


		LLog.info.write("\n RetrieveCostTotLedgerMstConfirmCmd --> result : "+result.toString());		
		

		LLog.info.write("\n RetrieveCostTotLedgerMstConfirmCmd --> result : currencyCd : "+result.getLData(0).getString("currencyCd"));	
		// Header 를 설정한다.
		...
		LLog.info.write("\n RetrieveCostTotLedgerMstConfirmCmd --> End \n");		
