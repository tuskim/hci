/*
 *------------------------------------------------------------------------------
 * RetrieveCostTotLedgerDtlMgntCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrieveCostTotLedgerDtlMgntCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveCostTotLedgerDtlMgntCmd --> Start \n");		
		...
		LMultiData result = biz.retrieveCostTotLedgerDtlMgnt(inputData);
		
		LLog.info.write("\n RetrieveCostTotLedgerDtlMgntCmd --> Start1 \n");	
		...
		gds.addDataColumn( new GauceDataColumn("areaCd"    				, GauceDataColumn.TB_STRING, 10));
		gds.addDataColumn( new GauceDataColumn("divCd"    				, GauceDataColumn.TB_STRING, 10));
		gds.addDataColumn( new GauceDataColumn("blockCd"    			, GauceDataColumn.TB_STRING, 10));
		gds.addDataColumn( new GauceDataColumn("blockCd2"    			, GauceDataColumn.TB_STRING, 10));
		gds.addDataColumn( new GauceDataColumn("yearCd"    				, GauceDataColumn.TB_STRING, 10));
		gds.addDataColumn( new GauceDataColumn("tmTbm"    				, GauceDataColumn.TB_STRING, 10));
		...
		gds.addDataColumn( new GauceDataColumn("workCd"    				, GauceDataColumn.TB_STRING, 3));
		gds.addDataColumn( new GauceDataColumn("workVendor"    		    , GauceDataColumn.TB_STRING, 10));
		gds.addDataColumn( new GauceDataColumn("workYm"    				, GauceDataColumn.TB_STRING, 6));
		gds.addDataColumn( new GauceDataColumn("sp"    				    , GauceDataColumn.TB_STRING, 100));
		gds.addDataColumn( new GauceDataColumn("chkyn"    			    , GauceDataColumn.TB_STRING, 100));
		gds.addDataColumn( new GauceDataColumn("workRentalType"       	, GauceDataColumn.TB_STRING, 100));
		gds.addDataColumn( new GauceDataColumn("wasteCd"    			, GauceDataColumn.TB_STRING, 2));
		...
		gds.addDataColumn( new GauceDataColumn("loadGbn"    			, GauceDataColumn.TB_STRING, 1));
		...
		LLog.info.write("\n RetrieveCostTotLedgerDtlMgntCmd --> End \n");		
