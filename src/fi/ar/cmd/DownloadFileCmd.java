...
public class DownloadFileCmd implements LCommandIF{
	...
	public void execute(HttpServletRequest req, HttpServletResponse res) throws Exception {
	    ...
	    try
	    {
			...
			LLog.debug.println("\n\n\n\n\n\n"+ DevOnHome.getHome() + File.separator + inputData.getString("fileFolder")  + File.separator + inputData.getString("filename"));
			File file = null;
			if(File.separator.equals("/")) // Unix
				file = new File(DevOnHome.getHome() + File.separator + inputData.getString("fileFolder")  + File.separator + inputData.getString("filename"));
			else
				file = new File(DevOnHome.getHome() + File.separator + inputData.getString("fileFolder")  + File.separator + inputData.getString("filename"));
