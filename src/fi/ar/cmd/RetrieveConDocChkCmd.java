/*
 *------------------------------------------------------------------------------
 * RetrieveConDocChkCmd.java,v 1.0 2010/10/06 16:43:35 
 * 
 * PROJ : PT-PAM
 ...
 * @see       
 */
public class RetrieveConDocChkCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LMultiData result = biz.retrieveConDocChk(inputData);
	    LGauceConverter.extractToGauceDataSet(result, gds); 
	    gds.flush();
	    
		LLog.info.write("\n RetrieveConDocChkCmd --> End \n");		
