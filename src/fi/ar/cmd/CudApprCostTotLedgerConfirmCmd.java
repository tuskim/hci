 ...
 * @see       
 */
public class CudApprCostTotLedgerConfirmCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudApprCostTotLedgerConfirmCmd ------------ START");

		GauceDataSet dataMstGds = gauceRequest.getGauceDataSet("IN_DS1");

		// Cost Total Ledger Master
		LMultiData mMstData = LGauceConverter.convertToLMultiDataWithJobType(dataMstGds);
		LLog.debug.write("CudApprCostTotLedgerConfirmCmd2 mMstData ---------------> =>\n " + mMstData.toString());

		if(dataMstGds == null ) return;
		...
		resultData = biz.cudApprCostTotLedgerConfirm(mMstData, loginUser); 
		...
		LLog.debug.write("CudApprCostTotLedgerConfirmCmd ------------ END");
