/*
 *------------------------------------------------------------------------------
 * RetrieveCostTotLedgerMstExcelListCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrieveCostTotLedgerMstExcelListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LMultiData result = biz.retrieveCostTotLedgerMstExcelList(inputData);
		
		LLog.info.write("\n RetrieveCostTotLedgerMstExcelListCmd result:" + result.toString());		
