/*
 *------------------------------------------------------------------------------
 * RetrieveCostTotLedgerVatVComboCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrieveCostTotLedgerVatVComboCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveCostTotLedgerVatVComboCmd --> Start \n");		
		...
		LMultiData result = biz.retrieveCostTotLedgerVatVCombo(inputData);
		...
		LLog.info.write("\n RetrieveCostTotLedgerVatVComboCmd --> End \n");		
