/*
 *------------------------------------------------------------------------------
 * RetrieveDocTypeWebComboListCmd.java,v 1.0 2010/10/06 16:43:35 
 * 
 * PROJ : PT-PAM
 ...
 * @see       
 */
public class RetrieveDocTypeWebComboListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveDocTypeWebComboListCmd --> Start \n");		
		...
		LMultiData result = biz.retrieveDocTypeWebComboList(inputData);
	    LGauceConverter.extractToGauceDataSet(result, gds); 
	    gds.flush();
	    
		LLog.info.write("\n RetrieveDocTypeWebComboListCmd --> End \n");		
