/*
 *------------------------------------------------------------------------------
 * CudDelCostTotLedgerValidationCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-MGE System.
 ...
 * @see       
 */
public class DelCostTotLedgerValidationCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("DelCostTotLedgerValidationCmd ------------ START");
		...
		resultData = biz.deleteCostTotLedgerValidation(mData, loginUser); 
		...
		LLog.debug.write("CudDelCostTotLedgerValidationCmd ------------ END");
