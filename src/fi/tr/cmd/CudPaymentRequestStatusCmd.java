/*
 *------------------------------------------------------------------------------
 * CudPaymentRequestStatusCmd.java 
 * 
 * PROJ : PT-MGE System.
...
public class CudPaymentRequestStatusCmd implements LGauceCommandIF {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudPaymentRequestStatusCmd --------------- START");
	    ...
	    LLog.debug.write("CudPaymentRequestStatusCmd mData (Request List 원본 데이타) ---------------> =>\n " + mData.toString());
		
  		PaymentBiz biz = new PaymentBiz();
		resultData = biz.cudPaymentRequestStatus(mData, inputData);
		
		getErrorCode = resultData.getLong("getErrorCode");
		getMessage	 = resultData.getString("getMessage");

		LLog.info.write("===================  Payment Request Stauts (Request List 정보) 수정 결과 MSG  ======================");
		...
		LLog.debug.write("CudPaymentRequestStatusCmd --------------- END");
