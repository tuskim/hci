/*
 *------------------------------------------------------------------------------
 * CudPaymentRequestConfirmStatusCmd.java 
 * 
 * PROJ : PT-MGE System.
...
public class CudPaymentRequestConfirmStatusCmd implements LGauceCommandIF {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudPaymentRequestConfirmStatusCmd --------------- START");
	    ...
	    LLog.debug.write("CudPaymentRequestConfirmStatusCmd mData  ---------------> =>\n " + mData.toString());
		
  		PaymentBiz biz = new PaymentBiz();
		resultData = biz.cudPaymentRequestConfirmStatus(mData, inputData);
		
		getErrorCode = resultData.getLong("getErrorCode");
		getMessage	 = resultData.getString("getMessage");

		LLog.info.write("===================  Payment Request Confirm Stauts (Request List 정보) 수정 결과 MSG  ======================");
		...
		LLog.debug.write("CudPaymentRequestConfirmStatusCmd --------------- END");
