/*
 *------------------------------------------------------------------------------
 * CudPaymentRequestDeleteCmd.java 
 * 
 * PROJ : PT-MGE System.
...
public class CudPaymentRequestDeleteCmd implements LGauceCommandIF {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudPaymentRequestDeleteCmd --------------- START");
	    ...
	    LLog.debug.write("CudPaymentRequestDeleteCmd mData  ---------------> =>\n " + mData.toString());
		
  		PaymentBiz biz = new PaymentBiz();
		resultData = biz.cudPaymentRequestDelete(mData, inputData);
		
		getErrorCode = resultData.getLong("getErrorCode");
		getMessage	 = resultData.getString("getMessage");

		LLog.info.write("===================  Payment Request List 정보 삭제 결과 MSG  ======================");
		...
		LLog.debug.write("CudPaymentRequestDeleteCmd --------------- END");
