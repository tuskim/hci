/*
 *------------------------------------------------------------------------------
 * CudPaymentRequestRejectCmd.java 
 * 
 * PROJ : PT-MGE System.
...
public class CudPaymentRequestRejectCmd implements LGauceCommandIF {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudPaymentRequestRejectCmd --------------- START");
	    ...
	    LLog.debug.write("CudPaymentRequestRejectCmd mData  ---------------> =>\n " + mData.toString());
		
  		PaymentBiz biz = new PaymentBiz();
		resultData = biz.cudPaymentRequestReject(mData, inputData);
		
		getErrorCode = resultData.getLong("getErrorCode");
		getMessage	 = resultData.getString("getMessage");

		LLog.info.write("===================  Payment Request Confirm 화면 Reject (Request List 정보) 수정 결과 MSG  ======================");
		...
		LLog.debug.write("CudPaymentRequestRejectCmd --------------- END");
