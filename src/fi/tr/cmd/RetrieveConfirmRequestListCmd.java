/*
 *-------------------------------------------------------------------------------
 * RetrieveConfirmRequestListCmd.java 
 * 
 * PROJ : PT-PAM 
...
public class RetrieveConfirmRequestListCmd implements LGauceCommandIF  {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveConfirmRequestListCmd --> Start \n");		
	    ...
	    LLog.info.write("===================  Payment Request Confirm List 조회 PARAM  ======================");
		...
		LMultiData result = biz.retrieveConfirmRequestList(inputData);
		
		LLog.info.write("\n RetrieveConfirmRequestListCmd result:" + result.toString());				
		...
		LLog.info.write("\n RetrieveConfirmRequestListCmd --> End \n");		
