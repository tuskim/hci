/* ------------------------------------------------------------------------
 * @source  : CudAssetRetirementRequestCmd.java
 * @desc    : 자산 폐기 요청 정보 등록 처리
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
 * VER  DATE         AUTHOR             DESCRIPTION
 * ---  -----------  -----------------  -----------------------------------
 * 1.0  2016.01.07   hckim              Initial
 * ------------------------------------------------------------------------ */
...
public class CudAssetRetirementRequestCmd implements LCommandIF {
    /**
	...
	public void execute(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		LLog.info.println("CudAssetRetirementRequestCmd ================  start");
    	...
    	LLog.info.println("==================  자산 폐기 요청 정보 등록 PARAM  ====================");
        ...
        inputData.setString("requestType", "R");
    	...
    	LLog.info.println("CudAssetRetirementRequestCmd ================  end");
