/*
 *------------------------------------------------------------------------------
 * RetrieveProductionApprovalCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrieveProductionApprovalCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveProductionApprovalCmd --> Start \n");		
    	...
    	result = biz.retrieveProductionApprovalAnyList(inputData);
		...
		LLog.info.write("\n RetrieveProductionApprovalCmd --> End \n");		
