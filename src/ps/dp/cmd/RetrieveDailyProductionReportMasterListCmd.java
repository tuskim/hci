/*
 *------------------------------------------------------------------------------
 * RetrieveDailyProductionReportMasterListCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
...
import ps.dp.biz.DailyProductionReportBiz;
 ...
 * @see       
 */
public class RetrieveDailyProductionReportMasterListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
	    ...
	    DailyProductionReportBiz biz = new DailyProductionReportBiz();

	    LMultiData result = null;
    	result = biz.retrieveDailyProductionReportMasterList(inputData);
