/* ------------------------------------------------------------------------
 * @source  : CudCementProductionRejectCmd.java
 * @desc    : Cement Production Reject
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudCementProductionRejectCmd implements LGauceCommandIF {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudCementProductionRejectCmd inputData--------------- Start \n");
		...
		if(userGdsMst == null){
			LLog.debug.write("CudCementProductionRejectCmd : DS_GRID   Null Point Error! \n");
			return;
		}
		...
		LLog.debug.println("CudCementProductionRejectCmd inputData MstDataSet--------------- =>\n " + mDataMst.toString());
	
		CementProductionBiz biz = new CementProductionBiz();
		
		resultData = biz.cudCementProductionReject(mDataMst, loginUser);		
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudCementProductionRejectCmd inputData--------------- End \n");
