/* ------------------------------------------------------------------------
 * @source  : CudCementProductionSAPCancelCmd.java
 * @desc    : Cement Production SAP Cancel
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudCementProductionSAPCancelCmd implements LGauceCommandIF {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudCementProductionSAPCancelCmd ------------ START");

		GauceDataSet ds_master = gauceRequest.getGauceDataSet("IN_DS1");
		
		LData inputData = LXssCollectionUtility.getData(req);
		LLog.debug.write("CudCementProductionSAPCancelCmd inputData ---------------> =>\n " + inputData.toString());
		...
		LLog.debug.write("CudCementProductionSAPCancelCmd HEADER 자료~~~~ ---------------> =>\n " + mData.toString());
		...
		LLog.debug.write("CudCementProductionSAPCancelCmd ------------ END");
