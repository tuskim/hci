/* ------------------------------------------------------------------------
 * @source  : CudCementProductionRegCmd.java
 * @desc    : Cement Production Save
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudCementProductionRegCmd implements LGauceCommandIF {

	public void execute(HttpServletRequest req, HttpServletResponse res, 
	        GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
				
		LLog.debug.write("CudCementProductionRegCmd inputData--------------- Start \n");
		...
		if(userGdsMst == null || userGdsOutput == null || userGdsInput == null ){
			LLog.debug.write("CudCementProductionRegCmd : DS_GRID   Null Point Error! \n");
			return;
		}
		...
		LLog.debug.println("CudCementProductionRegCmd inputData MstDataSet--------------- =>\n " + mDataMst.toString());
		LLog.debug.println("CudCementProductionRegCmd inputData OutputDataSet --------------- =>\n " + mDataOutput.toString());
		LLog.debug.println("CudCementProductionRegCmd inputData InputDataSet --------------- =>\n " + mDataInput.toString());
	
		CementProductionBiz biz = new CementProductionBiz();
		
		resultData = biz.cudCementProductionRegMod(mDataMst, mDataOutput, mDataInput, loginUser);		
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudCementProductionRegCmd inputData--------------- End \n");
