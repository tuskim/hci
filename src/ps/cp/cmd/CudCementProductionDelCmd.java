/* ------------------------------------------------------------------------
 * @source  : CudCementProductionDelCmd.java
 * @desc    : Cement Production Delete
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudCementProductionDelCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudCementProductionDelCmd inputData--------------- Start \n");
		...
		if(userGdsMst == null){
			LLog.debug.write("CudCementProductionDelCmd : DS_GRID   Null Point Error! \n");
			return;
		}
		...
		LLog.debug.println("CudCementProductionDelCmd inputData MstDataSet--------------- =>\n " + mDataMst.toString());
	
		CementProductionBiz biz = new CementProductionBiz();
		
		resultData = biz.cudCementProductionDelete(mDataMst, loginUser);		
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudCementProductionDelCmd inputData--------------- End \n");
