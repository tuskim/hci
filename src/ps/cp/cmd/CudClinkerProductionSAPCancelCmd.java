/* ------------------------------------------------------------------------
 * @source  : CudClinkerProductionSAPCancelCmd.java
 * @desc    : Clinker Production SAP Cancel
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudClinkerProductionSAPCancelCmd implements LGauceCommandIF {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudClinkerProductionSAPCancelCmd ------------ START");

		GauceDataSet ds_master = gauceRequest.getGauceDataSet("IN_DS1");
		
		LData inputData = LXssCollectionUtility.getData(req);
		LLog.debug.write("CudClinkerProductionSAPCancelCmd inputData ---------------> =>\n " + inputData.toString());
		...
		LLog.debug.write("CudClinkerProductionSAPCancelCmd HEADER 자료~~~~ ---------------> =>\n " + mData.toString());
		...
		LLog.debug.write("CudClinkerProductionSAPCancelCmd ------------ END");
