/* ------------------------------------------------------------------------
 * @source  : RetrieveCementProductionExcelListCmd.java
 * @desc    : Cement Production Excel List 조회
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
 * VER  DATE         AUTHOR             DESCRIPTION
 * ---  -----------  -----------------  -----------------------------------
 * 1.0  2016.08.09   kjkim               Initial
 * ------------------------------------------------------------------------ */
...
public class RetrieveCementProductionExcelListCmd implements LGauceCommandIF  {
    /**
     * 
     *
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
		...
		LLog.debug.write("RetrieveCementProductionExcelListCmd --> Start");
	    ...
	    result = biz.RetrieveCementProductionExcelList(lData);
	    
		LGauceConverter.extractToGauceDataSet(result, dsGrid);
		
		dsGrid.flush();
		
		LLog.debug.write("RetrieveCementProductionExcelListCmd --> End");	
