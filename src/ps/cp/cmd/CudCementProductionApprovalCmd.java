/* ------------------------------------------------------------------------
 * @source  : CudCementProductionApprovalCmd.java
...
public class CudCementProductionApprovalCmd implements LGauceCommandIF {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudCementProductionApprovalCmd inputData--------------- Start \n");
		...
		if(userGdsMst == null){
			LLog.debug.write("CudCementProductionApprovalCmd : DS_GRID   Null Point Error! \n");
			return;
		}
		...
		resultData = biz.cudCementProductionApproval(mDataMst, loginUser);		
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudCementProductionApprovalCmd inputData--------------- End \n");
