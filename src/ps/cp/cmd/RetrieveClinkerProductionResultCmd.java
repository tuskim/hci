/* ------------------------------------------------------------------------
 * @source  : RetrieveClinkerProductionResultCmd.java
 * @desc    : Result of Clinker 조회
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class RetrieveClinkerProductionResultCmd implements LGauceCommandIF {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
		...
		LLog.debug.write("RetrieveClinkerProductionResultCmd --> Start");
		
    	
		ClinkerProductionBiz biz = new ClinkerProductionBiz();
		GauceDataSet 	dsGrid 	= new GauceDataSet("ds_resultOfClinker");
		...
		LGauceConverter.extractToGauceDataSet( biz.retrieveClinkerProductionResult(lData), dsGrid );
		dsGrid.flush();
		
		LLog.debug.write("RetrieveClinkerProductionResultCmd --> End");	
