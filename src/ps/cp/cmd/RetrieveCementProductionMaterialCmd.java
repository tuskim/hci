/* ------------------------------------------------------------------------
 * @source  : RetrieveCementProductionMaterialCmd.java
 * @desc    : Use of Material for Cement 조회
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class RetrieveCementProductionMaterialCmd implements LGauceCommandIF {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse res, GauceRequest gauceRequest, GauceResponse gauceResponse) throws Exception {
		...
		LLog.debug.write("RetrieveCementProductionMaterialCmd --> Start");
		...
		LGauceConverter.extractToGauceDataSet( biz.retrieveCementProductionMaterial(lData), dsGrid );
		dsGrid.flush();
		
		LLog.debug.write("RetrieveCementProductionMaterialCmd --> End");	
