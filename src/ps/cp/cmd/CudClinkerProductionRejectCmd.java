/* ------------------------------------------------------------------------
 * @source  : CudClinkerProductionRejectCmd.java
 * @desc    : Clinker Production Reject
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudClinkerProductionRejectCmd implements LGauceCommandIF {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudClinkerProductionRejectCmd inputData--------------- Start \n");
		...
		if(userGdsMst == null){
			LLog.debug.write("CudClinkerProductionRejectCmd : DS_GRID   Null Point Error! \n");
			return;
		}
		...
		LLog.debug.println("CudClinkerProductionRejectCmd inputData MstDataSet--------------- =>\n " + mDataMst.toString());
	
		ClinkerProductionBiz biz = new ClinkerProductionBiz();
		
		resultData = biz.cudClinkerProductionReject(mDataMst, loginUser);		
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudClinkerProductionRejectCmd inputData--------------- End \n");
