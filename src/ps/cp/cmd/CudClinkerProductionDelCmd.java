/* ------------------------------------------------------------------------
 * @source  : CudClinkerProductionDelCmd.java
 * @desc    : Clinker Production Delete
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudClinkerProductionDelCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudClinkerProductionDelCmd inputData--------------- Start \n");
		...
		if(userGdsMst == null){
			LLog.debug.write("CudClinkerProductionDelCmd : DS_GRID   Null Point Error! \n");
			return;
		}
		...
		LLog.debug.println("CudClinkerProductionDelCmd inputData MstDataSet--------------- =>\n " + mDataMst.toString());
	
		ClinkerProductionBiz biz = new ClinkerProductionBiz();
		
		resultData = biz.cudClinkerProductionDelete(mDataMst, loginUser);		
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudClinkerProductionDelCmd inputData--------------- End \n");
