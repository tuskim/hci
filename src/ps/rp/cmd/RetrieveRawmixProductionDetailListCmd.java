/*
 *------------------------------------------------------------------------------
 * RetrieveRawmixProductionDetailListCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrieveRawmixProductionDetailListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveRawmixProductionDetailListCmd --> Start \n");		
		...
		LMultiData result = biz.retrieveRawmixProductionDetailList(inputData);
		...
		LLog.info.write("\n RetrieveRawmixProductionDetailListCmd --> End \n");		
