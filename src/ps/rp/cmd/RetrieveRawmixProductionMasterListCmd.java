/*
 *------------------------------------------------------------------------------
 * RetrieveRawmixProductionMasterListCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrieveRawmixProductionMasterListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveRawmixProductionMasterListCmd --> Start \n");		
	    ...
	    if("prodDate".equals(inputData.getString("sqlType"))) {
	    	result = biz.retrieveRawmixProductionMasterProdDate(inputData);
	    } else {
	    	result = biz.retrieveRawmixProductionMasterList(inputData);
	    }
		...
		LLog.info.write("\n RetrieveRawmixProductionMasterListCmd --> End \n");		
