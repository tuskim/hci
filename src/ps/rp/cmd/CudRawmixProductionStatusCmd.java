/*
 *------------------------------------------------------------------------------
 * CudRawmixProductionStatusCmd.java,v 1.0 2010/08/03 16:43:35 
 * 
 * PROJ : PT-PAM System.
 ...
 * @see       
 */
public class CudRawmixProductionStatusCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudRawmixProductionStatusCmd ------------ START");
		...
		resultData = biz.cudRawmixProductionStatus(MDataMaster, loginUser);
		...
		LLog.debug.write("CudRawmixProductionStatusCmd ------------ END");
