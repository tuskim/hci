/*
 *------------------------------------------------------------------------------
 * CudRawmixProductionCmd.java,v 1.0 2010/08/03 16:43:35 
 * 
 * PROJ : PT-PAM System.
 ...
 * @see       
 */
public class CudRawmixProductionCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudRawmixProductionCmd ------------ START");
		...
		LLog.debug.write("CudRawmixProductionCmd MDataDetail ---------------> =>\n " + MDataDetail);	
		LLog.debug.write("CudRawmixProductionCmd MDataResult ---------------> =>\n " + MDataResult);
        /////////////////////////////////////////////////////////////////////////////////
...
//		loginUser.set("poNo", inputData.get("poNo"));
		...
		resultData = biz.cudRawmixProduction(MDataMaster, MDataDetail, MDataResult, loginUser);
		...
		LLog.debug.write("CudRawmixProductionCmd ------------ END");
