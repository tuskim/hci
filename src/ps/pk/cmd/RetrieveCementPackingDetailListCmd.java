/*
 *------------------------------------------------------------------------------
 * RetrieveCementPackingDetailListCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrieveCementPackingDetailListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveCementPackingDetailListCmd --> Start \n");		
		...
		LMultiData result = biz.retrieveCementPackingDetailList(inputData);
		...
		LLog.info.write("\n RetrieveCementPackingDetailListCmd --> End \n");		
