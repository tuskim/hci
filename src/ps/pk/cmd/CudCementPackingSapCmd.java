/*
 *------------------------------------------------------------------------------
 * CudCementPackingSapCmd.java,v 1.0 2010/08/03 16:43:35 
 * 
 * PROJ : PT-PAM System.
 ...
 * @see       
 */
public class CudCementPackingSapCmd implements LGauceCommandIF {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudCementPackingSapCmd ------------ START");
		...
		if("f_sapSend".equals(inputData.getString("sapType"))) {
			// SAP Send
			resultData = biz.cudCementPackingSapSend(MDataMaster, loginUser);
		}

		if("f_sapCancel".equals(inputData.getString("sapType"))) {
			// SAP Cancel
			resultData = biz.cudCementPackingSapCancel(MDataMaster, loginUser);
		}
		...
		LLog.debug.write("CudCementPackingSapCmd ------------ END");
