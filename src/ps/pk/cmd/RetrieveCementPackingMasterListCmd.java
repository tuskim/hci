/*
 *------------------------------------------------------------------------------
 * RetrieveCementPackingMasterListCmd.java,v 1.0 2010/07/23 16:43:35 
 * 
 * PROJ : PT-PAM 
 ...
 * @see       
 */
public class RetrieveCementPackingMasterListCmd implements LGauceCommandIF  {
    /**
     * 
     *
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.info.write("\n RetrieveCementPackingMasterListCmd --> Start \n");		
	    ...
	    if("prodDate".equals(inputData.getString("sqlType"))) {
	    	result = biz.retrieveCementPackingMasterProdDate(inputData);
	    } else {
	    	result = biz.retrieveCementPackingMasterList(inputData);
	    }
		...
		LLog.info.write("\n RetrieveCementPackingMasterListCmd --> End \n");		
