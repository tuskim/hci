/* ------------------------------------------------------------------------
 * @source  : CudLimestoneProductionApprovalCmd.java
...
public class CudLimestoneProductionApprovalCmd implements LGauceCommandIF {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudLimestoneProductionApprovalCmd inputData--------------- Start \n");
		...
		if(userGdsMst == null){
			LLog.debug.write("CudLimestoneProductionApprovalCmd : DS_GRID   Null Point Error! \n");
			return;
		}
		...
		LLog.debug.println("CudLimestoneProductionApprovalCmd inputData MstDataSet--------------- =>\n " + mDataMst.toString());
	
		LimestoneProductionBiz biz = new LimestoneProductionBiz();
		
		resultData = biz.cudLimestoneProductionApproval(mDataMst, loginUser);		
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudLimestoneProductionApprovalCmd inputData--------------- End \n");
