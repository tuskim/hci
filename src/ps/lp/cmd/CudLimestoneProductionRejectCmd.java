/* ------------------------------------------------------------------------
 * @source  : CudLimestoneProductionRejectCmd.java
 * @desc    : Limestone Production Reject
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudLimestoneProductionRejectCmd implements LGauceCommandIF {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudLimestoneProductionRejectCmd inputData--------------- Start \n");
		...
		if(userGdsMst == null){
			LLog.debug.write("CudLimestoneProductionRejectCmd : DS_GRID   Null Point Error! \n");
			return;
		}
		...
		LLog.debug.println("CudLimestoneProductionRejectCmd inputData MstDataSet--------------- =>\n " + mDataMst.toString());
	
		LimestoneProductionBiz biz = new LimestoneProductionBiz();
		
		resultData = biz.cudLimestoneProductionReject(mDataMst, loginUser);		
		...
		getMessage	 = resultData.getString("getMessage");
		 ...
		 LLog.debug.write("CudLimestoneProductionRejectCmd inputData--------------- End \n");
