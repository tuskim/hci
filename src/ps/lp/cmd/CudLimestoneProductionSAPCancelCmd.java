/* ------------------------------------------------------------------------
 * @source  : CudLimestoneProductionSAPCancelCmd.java
 * @desc    : Limestone Production SAP Cancel
 * ------------------------------------------------------------------------
 *
 * ------------------------------------------------------------------------
...
public class CudLimestoneProductionSAPCancelCmd implements LGauceCommandIF {
	...
	public void execute(HttpServletRequest req, HttpServletResponse res, 
		...
		LLog.debug.write("CudLimestoneProductionSAPCancelCmd ------------ START");

		GauceDataSet ds_master = gauceRequest.getGauceDataSet("IN_DS1");
		
		LData inputData = LXssCollectionUtility.getData(req);
		LLog.debug.write("CudLimestoneProductionSAPCancelCmd inputData ---------------> =>\n " + inputData.toString());
		...
		LLog.debug.write("CudLimestoneProductionSAPCancelCmd HEADER 자료~~~~ ---------------> =>\n " + mData.toString());


		LimestoneProductionBiz biz = new LimestoneProductionBiz();
		resultData = biz.CudCpoProductionSapCancel(mData, loginUser);
		...
		LLog.debug.write("CudLimestoneProductionSAPCancelCmd ------------ END");
