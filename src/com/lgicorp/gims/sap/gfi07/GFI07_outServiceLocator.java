...
public class GFI07_outServiceLocator extends org.apache.axis.client.Service implements com.lgicorp.gims.sap.gfi07.GFI07_outService {

    public GFI07_outServiceLocator() {
    }


    public GFI07_outServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public GFI07_outServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTPS_Port
    private java.lang.String HTTPS_Port_address = "https://165.244.231.15:50001/XISOAPAdapter/MessageServlet?senderParty=&senderService=GIMS&receiverParty=&receiverService=&interface=GFI07_out&interfaceNamespace=http%3A%2F%2Flgicorp.com%2Fgims%2Fsap%2Fgfi";
    ...
    public com.lgicorp.gims.sap.gfi07.GFI07_out getHTTPS_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lgicorp.gims.sap.gfi07.GFI07_outBindingStub _stub = new com.lgicorp.gims.sap.gfi07.GFI07_outBindingStub(portAddress, this);
    ...
    private java.lang.String HTTP_Port_address = "http://165.244.231.15:51000/XISOAPAdapter/MessageServlet?senderParty=&senderService=GIMS&receiverParty=&receiverService=&interface=GFI07_out&interfaceNamespace=http%3A%2F%2Flgicorp.com%2Fgims%2Fsap%2Fgfi";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lgicorp.gims.sap.gfi07.GFI07_out.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lgicorp.gims.sap.gfi07.GFI07_outBindingStub _stub = new com.lgicorp.gims.sap.gfi07.GFI07_outBindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
            if (com.lgicorp.gims.sap.gfi07.GFI07_out.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lgicorp.gims.sap.gfi07.GFI07_outBindingStub _stub = new com.lgicorp.gims.sap.gfi07.GFI07_outBindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://lgicorp.com/gims/sap/gfi", "GFI07_outService");
    }
